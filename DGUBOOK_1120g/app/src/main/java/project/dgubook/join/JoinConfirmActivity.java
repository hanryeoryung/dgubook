...
//            Toast.makeText(CosmeticItemDetailActivity.this, Integer.toString(itemNum), Toast.LENGTH_SHORT).show();
    ...
    private int toAddUser() {
        ...
        try {
            ...
            URL mUrl = new URL("http://210.94.222.136/dgubook_join.php?email=" + URLEncoder.encode(uEmail, "UTF-8") + "&name=" + uName +
                    "&student_id=" + URLEncoder.encode(uStudent, "UTF-8") + "&password=" + URLEncoder.encode(uPassword, "UTF-8"));
